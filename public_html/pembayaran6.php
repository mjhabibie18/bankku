...
<div class="container-fluid text-center">    
  <div class="row content">
    ...
    <li><?php $_SESSION["hotelsister.com"] = "hotelsister.com"; ?><a href="pembayaran6.php">hotelsister.com</a></li> </ul>
    </li>
    ...
    <div class="col-sm-8 text-left"> 
      ...
      <table class="table-responsive table-condensed">
        ...
        <form id="form1" action="http://iqbalabdurrazaq.000webhostapp.com/serverClient/JSON/server_UpdatePembelian.php" method="post">
        <tr>
          <td><label for="ex3">Nama Tujuan</label></td>
          <td><input type='text' name='nama_penerima' class="form-control" id='nama_penerima' value='<?php echo $_SESSION["hotelsister.com"]; ?>' readonly /></td>
        </tr>
        <?php
        ...
        //   echo "<td><input type='text' class='form-control' name='nama_penerima' value='' id='nama_penerima' readonly /></td>";
          ...
          $curl = curl_init();
          curl_setopt($curl, CURLOPT_URL, "http://iqbalabdurrazaq.000webhostapp.com/serverClient/JSON/api_bankku.php?invoice=$id_pembelian");
