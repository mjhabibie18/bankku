...
<div class="container-fluid text-center">    
  ...
  <div class="col-sm-2 sidenav">
    ...
    <ul class="dropdown-menu">
      <li class="active"><a class="dropdown-toggle" data-toggle="dropdown"  href="menu.php">Informasi Saldo</a></li>
      <li><a class="dropdown-toggle" href="menu2.php">Informasi Mutasi</a></li> 
